    ...
    return (
        <div id="contentGestionProfil" className="flex flex-col items-center justify-center h-[750px] sm:h-[500px] md:h-[750px] lg:h-[1000px] w-full bg-white gap-8">
            ...
            <div className='flex items-center justify-center w-full'>
                <div className="flex flex-col w-[50%] md:w-[25%] h-full md:h-full md:gap-6 justify-center pl-2 md:pl-0">
                    ...
                    <div className="md:hidden flex flex-col md:h-full justify-start mt-6">
                ...
                <div className='w-[50%] md:w-[40%] md:mx-[2%] md:px-8'>
                    <img src={profileContentImage} alt="Exemple of the profile functionalities" />
                </div>

                <div className="hidden md:flex flex-col w-[25%] h-full gap-6 justify-start mt-[8%]">
                    <h5 className='text-lg md:text-2xl lg:text-4xl text-blue-400 font-semibold'>
                        Rester informé
                    </h5>
