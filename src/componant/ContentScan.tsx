        ...
        <div id="contentScan" className="flex items-center justify-center h-[750px] sm:h-[700px] lg:h-[900px]">
            <div className='flex flex-col items-center justify-start w-full h-full'>
                ...
                <div className='flex justify-center items-center'>
                    ...
                    <h3 className='text-2xl md:text-4xl xl:text-6xl font-medium text-gray-800'>
                ...
                <div className='flex flex-col items-center justify-center w-[90%] h-[80%] gap-10'>
                    ...
                    <div className='flex gap-[5%] h-full sm:h-auto sm:flex-row flex-col items-center justify-center'>
                        <div className='flex flex-col w-[90%] sm:w-[55%] h-full gap-6'>
                        ...
                        <div className='flex h-full w-[30%] items-center justify-center gap-2 md:gap-4 lg:gap-6'>
