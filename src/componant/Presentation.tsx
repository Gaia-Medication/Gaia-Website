  ...
  return (
    <div className="flex flex-col items-center md:h-[750px] xl:h-[900px] h-[1250px] gap-8 md:gap-[10%]" id="presentation">
      ...
      <div className="flex md:flex-row flex-col flex-wrap items-center justify-center mt-8 w-[90%]">
        <div className="flex flex-col items-center gap-2 bg-white rounded-lg md:shadow-lg shadow-neutral-100 p-6 pt-10 mx-0 sm:mx-6 md:w-[25%] w-full sm:w-[80%] max-h-[340px] sm:max-h-[500px] xl:min-h-[500px] duration-200 md:hover:shadow-indigo-100 overflow-auto">
        ...
        <div className="flex flex-col items-center gap-2 bg-white rounded-lg md:shadow-lg shadow-neutral-100 p-6 pt-10 mx-0 sm:mx-6 md:w-[25%] w-full sm:w-[80%] max-h-[340px] sm:max-h-[500px] xl:min-h-[500px] duration-200 md:hover:shadow-yellow-100 overflow-auto">
        ...
        <div className="flex flex-col items-center gap-2 bg-white rounded-lg md:shadow-lg shadow-neutral-100 p-6 pt-10 mx-0 sm:mx-6 md:w-[25%] w-full sm:w-[80%] max-h-[340px] sm:max-h-[500px] xl:min-h-[500px] duration-200 md:hover:shadow-cyan-100 overflow-auto">
