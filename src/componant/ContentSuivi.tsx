    ...
    return (
        <div id="suivi" className="flex xl:flex-row flex-col-reverse items-center md:justify-center justify-around w-full xl:h-[800px] md:h-[1200px] sm:h-[1000px] h-[900px] bg-lime-400">
            <div className="flex items-center justify-center gap-2 xl:w-[40%] w-[70%] h-full">
                ...
                <img src={ExampleStock} alt="Example of a medicine stock" className='w-[30%] transition-all duration-500'/>
            </div>
            ...
            <div className='flex flex-col justify-center xl:w-[60%] w-[90%] xl:p-[8%] px-[8%] pt-[8%] gap-6'>
                ...
                <p className='text-base sm:text-xl md:text-2xl font-base sm:font-light text-white transition-all duration-500'>
                    Gaia vous permet de créer vos propres traitements à partir de vos indications médicales ou en scannant votre ordonnance.
                    <br />Une fois votre traitement créé, Gaia crée un planning de prise de médicaments et vous notifie pour chaque médicament à prendre.
                    <br /><br />Gaia suit également votre stock de médicaments, garantissant aucun oubli et une gestion simplifiée de vos médicaments.
                </p>
                <p className='text-base sm:text-xl md:text-2xl font-semibold sm:font-medium text-white transition-all duration-500'>
                    Grâce à l'interface intuitive de Gaia, vous avez accès à toutes les informations de votre traitement et de votre stock en un clin d'œil grâce à un résumé.
                </p>
            </div>
        </div>
    )
