...
function Home() {
  return (
    <div className=" min-w-[360px]">
      <meta name="description" content="Gaia Medication : votre application gratuite de santé pour une gestion complète des traitements, rappels de médicaments et suivi des stocks. Inclut la gestion des effets secondaires, une carte interactive des établissements de santé et des médecins, ainsi qu'une communication facilitée avec les professionnels de santé par l'envoi de résumés PDF. Simplifiez votre suivi médical et gardez le contrôle de votre bien-être."></meta>
      <Header></Header>
      <Showcase></Showcase>
